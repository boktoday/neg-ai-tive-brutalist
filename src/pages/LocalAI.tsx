...
const ramTiers = [
  {
    ...
    models: [
      { name: 'Qwen3-1.7B-Instruct (Q4)', type: 'Text', size: '~1.2GB', speed: '40-60 t/s', use: 'Latest gen Qwen. Chat, summarisation, writing. Updated May 2025.' },
      { name: 'DeepSeek-R1-Distill-Qwen-1.5B', type: 'Reasoning', size: '~1GB', speed: '35-50 t/s', use: 'Reasoning-focused distilled model. Great for logic tasks.' },
      { name: 'Qwen3-0.6B-Instruct (Q4)', type: 'Text', size: '~500MB', speed: '60-80 t/s', use: 'Ultra-lightweight. Fast inferences for simple tasks.' },
      { name: 'Qwen2.5-1.5B-Instruct (Q4)', type: 'Text', size: '~1GB', speed: '45-65 t/s', use: 'Reliable all-rounder. Most downloaded Qwen GGUF.' },
      { name: 'Qwen2.5-Coder-1.5B (Q4)', type: 'Code', size: '~1GB', speed: '35-55 t/s', use: 'Code completion, debugging, simple refactors.' },
    ],
  ...
  },
  {
    ...
    models: [
      { name: 'Qwen3-8B-Instruct (Q4)', type: 'Text', size: '~5.5GB', speed: '10-18 t/s', use: 'Latest Qwen3 gen. Superior reasoning, full chat, analysis.' },
      { name: 'Qwen3-4B-Instruct (Q4)', type: 'Text', size: '~3GB', speed: '18-28 t/s', use: 'Sweet spot. Excellent quality-to-speed ratio for 16GB.' },
      { name: 'DeepSeek-R1-Distill-Qwen-7B (Q4)', type: 'Reasoning', size: '~5GB', speed: '8-14 t/s', use: 'R1 reasoning distillation. Mathematical/logic tasks.' },
      { name: 'Qwen2.5-7B-Instruct (Q4)', type: 'Text', size: '~4.5GB', speed: '12-20 t/s', use: 'Proven all-rounder. Most downloaded 7B GGUF.' },
      { name: 'Qwen2.5-Coder-7B (Q4)', type: 'Code', size: '~4.5GB', speed: '12-18 t/s', use: 'Advanced code generation, refactoring, debugging.' },
  ...
  },
  {
    ...
    models: [
      { name: 'Qwen3-30B-A3B (Q4)', type: 'Text', size: '~18GB', speed: '10-18 t/s', use: 'MoE architecture. 30B params with 3B active. Fast & smart.' },
      { name: 'Qwen3-14B-Instruct (Q4)', type: 'Text', size: '~9GB', speed: '8-14 t/s', use: 'Latest Qwen3. Superior reasoning, 128K context.' },
      { name: 'Qwen3.6-27B-MTP (Q4)', type: 'Text', size: '~18GB', speed: '5-12 t/s', use: 'Multi-Token Prediction. 262K context. GPT-4 competitor.' },
      { name: 'Qwen3-32B-Instruct (Q4)', type: 'Text', size: '~18GB', speed: '3-6 t/s', use: 'Near frontier-level. 32B params. Deep reasoning.' },
      { name: 'Qwen2.5-14B-Instruct (Q4)', type: 'Text', size: '~9GB', speed: '8-14 t/s', use: 'Proven 14B. Great for long-form analysis.' },
      { name: 'Hermes-2-Pro-12B (Q4)', type: 'Agent', size: '~8GB', speed: '8-14 t/s', use: 'Advanced agent capabilities, multi-tool orchestration.' },
    ],
...
const cloudModels = [
  { name: 'MiniMax', region: 'China', models: 'MiniMax-M3 (latest), MiniMax-M1, speech-2.8-hd, image-01, video-01', pricing: 'M3: ~$1.20/M input tokens, speech-2.8: ~$0.02/min', note: 'M3 is frontier-level. Speech-2.8-hd is best-in-class TTS. Video generation available.' },
  { name: 'DeepSeek', region: 'China', models: 'DeepSeek-V3, DeepSeek-R1, DeepSeek-Coder-V2', pricing: '~$0.14-0.27/M tokens (V3), $0.55/M (R1)', note: 'Best value coding models. R1 matches o1-preview reasoning at fraction of cost. 1M context.' },
