...
const allProducts = [
  ...
  // Mugs
  { name: "NEG-AI-TIVE", type: "Mug (White)", price: "$24.99+", mockup: "/designs/rebrand/mug-neg-ai-tive-bw.png", printfulId: null },
  { name: "NEG-AI-TIVE", type: "Mug (Black)", price: "$24.99+", mockup: "/designs/rebrand/mug-neg-ai-tive-wb.png", printfulId: null },
  { name: "CHATBOT STOLE MY CHILD", type: "Mug (White)", price: "$24.99+", mockup: "/designs/rebrand/mug-chatbot-bw.png", printfulId: null },
];
